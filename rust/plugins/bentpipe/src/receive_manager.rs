...
pub unsafe fn emane_bentpipe_receivemanager_cxx_now(cpp_this: *mut c_void) -> u64 { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_drop_lock( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, msg_ptr: *mut c_void, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_drop_spectrum_service( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, msg_ptr: *mut c_void, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_drop_sinr( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, msg_ptr: *mut c_void, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_drop_bad_curve( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, msg_ptr: *mut c_void, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_publish_drop_destination_mac( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, msg_ptr: *mut c_void, msg_index: usize, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_publish_accept_good( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, msg_ptr: *mut c_void, msg_index: usize, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_publish_accept_good_len( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, dst: u16, length: usize, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_check_spectrum( cpp_this: *mut c_void, rx_antenna_index: u16, freq_hz: u64, span: u64, sor: u64, rx_power_dbm: f64, out_noise_floor: *mut f64, out_signal_in_noise: *mut bool, ) -> c_int { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_get_por( cpp_this: *mut c_void, pcr_curve_index: u16, sinr: f64, length: usize, out_por: *mut f32, ) -> c_int { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_get_random(cpp_this: *mut c_void) -> f32 { 0.0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_update_neighbor_metrics( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, transponder_index: u16, sinr: f64, noise_floor: f64, sor: u64, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_get_messages_count(msg_ptr: *mut c_void) -> usize { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_msg_get_dst(msg_ptr: *mut c_void, index: usize) -> u16 { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_msg_is_fragment( msg_ptr: *mut c_void, index: usize, ) -> bool { false }
pub unsafe fn emane_bentpipe_receivemanager_cxx_msg_get_fragment_index( msg_ptr: *mut c_void, index: usize, ) -> usize { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_msg_get_fragment_offset( msg_ptr: *mut c_void, index: usize, ) -> usize { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_msg_get_fragment_sequence( msg_ptr: *mut c_void, index: usize, ) -> u64 { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_msg_is_more_fragments( msg_ptr: *mut c_void, index: usize, ) -> bool { false }
pub unsafe fn emane_bentpipe_receivemanager_cxx_msg_get_data( msg_ptr: *mut c_void, index: usize, out_len: *mut usize, ) -> *const u8 { std::ptr::null_mut() }
pub unsafe fn emane_bentpipe_receivemanager_cxx_pktinfo_get_src(pkt_info_ptr: *mut c_void) -> u16 { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_bpm_get_pcr_curve_index(msg_ptr: *mut c_void) -> u16 { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_freq_get_frequency_hz(freq_ptr: *mut c_void) -> u64 { 0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_freq_get_rx_power_dbm(freq_ptr: *mut c_void) -> f64 { 0.0 }
pub unsafe fn emane_bentpipe_receivemanager_cxx_forward_upstream( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, dst: u16, data: *const u8, len: usize, ) { (crate::FW_SERVICE.as_ref().unwrap().send_upstream_packet)(std::ptr::null_mut(), 0, std::ptr::null(), std::ptr::null(), 0); }
pub unsafe fn emane_bentpipe_receivemanager_cxx_bend_downstream( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, dst: u16, data: *const u8, len: usize, ) { (crate::FW_SERVICE.as_ref().unwrap().send_downstream_packet)(std::ptr::null_mut(), 0, std::ptr::null(), std::ptr::null(), 0); }
pub unsafe fn emane_bentpipe_receivemanager_cxx_forward_upstream_parts( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, dst: u16, data_ptrs: *const *const u8, data_lens: *const usize, num_parts: usize, ) { (crate::FW_SERVICE.as_ref().unwrap().send_upstream_packet)(std::ptr::null_mut(), 0, std::ptr::null(), std::ptr::null(), 0); }
pub unsafe fn emane_bentpipe_receivemanager_cxx_bend_downstream_parts( cpp_this: *mut c_void, pkt_info_ptr: *mut c_void, dst: u16, data_ptrs: *const *const u8, data_lens: *const usize, num_parts: usize, ) { (crate::FW_SERVICE.as_ref().unwrap().send_downstream_packet)(std::ptr::null_mut(), 0, std::ptr::null(), std::ptr::null(), 0); }
pub unsafe fn emane_bentpipe_receivemanager_cxx_schedule_process(cpp_this: *mut c_void, eor: u64) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_drop_miss_fragment( cpp_this: *mut c_void, src: u16, dst: u16, total_bytes: usize, ) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_delete_msg(ptr: *mut c_void) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_delete_pkt_info(ptr: *mut c_void) {}
pub unsafe fn emane_bentpipe_receivemanager_cxx_delete_freq_segments(ptr: *mut c_void) {}
