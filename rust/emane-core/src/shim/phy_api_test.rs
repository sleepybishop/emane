...
#[no_mangle]
pub extern "C" fn emane_phyapitest_processUpstreamControl(
    _layer: *mut c_void,
    _msgs: *const c_void,
) {
...
#[no_mangle]
pub extern "C" fn emane_phyapitest_processDownstreamControl(
    _layer: *mut c_void,
    _msgs: *const c_void,
) {
    let msg = CString::new("SHIMI unexpected control message, drop").unwrap();
...
#[no_mangle]
pub extern "C" fn emane_phyapitest_processUpstreamPacket(
    _layer: *mut c_void,
    _pkt: *mut c_void,
    _msgs: *const c_void,
) {
...
#[no_mangle]
pub extern "C" fn emane_phyapitest_processDownstreamPacket(
    _layer: *mut c_void,
    _pkt: *mut c_void,
    _msgs: *const c_void,
) {
