...
extern "C" {
    ...
    pub fn emane_downstreampacket_get_packetinfo(pkt: *const DownstreamPacket)
        -> *const PacketInfo;
    ...
    pub fn emane_controlmessages_find(
...
extern "C" {
    ...
    pub fn emane_ieee80211abg_maclayer_processInbound(
        maclayer: *mut c_void,
        category: u8,
        pkt: *mut DownstreamPacket,
    );
    pub fn emane_ieee80211abg_maclayer_processOutbound(
        maclayer: *mut c_void,
        category: u8,
        pkt: *mut DownstreamPacket,
        drop_code: i32,
    ...
    pub fn emane_ieee80211abg_maclayer_createDownstreamQueueEntry(
        maclayer: *mut c_void,
        pkt: *mut DownstreamPacket,
        category: u8,
        retries: u8,
    ...
    pub fn emane_ieee80211abg_maclayer_getHasPendingDownstreamQueueEntry(
        maclayer: *mut c_void,
    ) -> bool;
    pub fn emane_ieee80211abg_maclayer_setHasPendingDownstreamQueueEntry(
        maclayer: *mut c_void,
        value: bool,
    );
    pub fn emane_ieee80211abg_maclayer_setPendingDownstreamQueueEntry(
        maclayer: *mut c_void,
        entry: *mut c_void,
    );
    pub fn emane_ieee80211abg_maclayer_enqueueDownstreamQueueEntry(
        maclayer: *mut c_void,
        entry: *mut c_void,
        category: u8,
    );
    pub fn emane_ieee80211abg_maclayer_isCurrentEndOfTransmissionTimePast(
        maclayer: *mut c_void,
    ) -> bool;
    pub fn emane_ieee80211abg_maclayer_handleDownstreamQueueEntry(maclayer: *mut c_void);
    pub fn emane_ieee80211abg_maclayer_scheduleDownstreamQueue(
        maclayer: *mut c_void,
        waitTimeMicro: u64,
    );
    pub fn emane_ieee80211abg_maclayer_getPendingDownstreamQueueEntry(
        maclayer: *mut c_void,
    ) -> *mut c_void;
    pub fn emane_ieee80211abg_maclayer_getTxState(maclayer: *mut c_void) -> *mut c_void;
    pub fn emane_ieee80211abg_tx_state_machine_getWaitTime(
        ptr: *mut c_void,
        entry: *mut c_void,
        out_time: *mut u64,
    ) -> bool;
...
pub extern "C" fn emane_ieee80211abg_mac_layer_processDownstreamPacket(
    ...
    unsafe {
        ...
        if !emane_ieee80211abg_maclayer_removeToken(maclayer) {
            emane_ieee80211abg_maclayer_processOutbound(
                maclayer,
                category,
                pkt,
        ...
        let entry = emane_ieee80211abg_maclayer_createDownstreamQueueEntry(
            maclayer,
            pkt,
            category,
            retries,
        ...
        if emane_ieee80211abg_maclayer_getHasPendingDownstreamQueueEntry(maclayer) {
            ...
            let pending_entry =
                emane_ieee80211abg_maclayer_getPendingDownstreamQueueEntry(maclayer);
            let has_wait = emane_ieee80211abg_tx_state_machine_getWaitTime(
                tx_state,
                pending_entry,
                &mut wait_time_micro,
            );
...
extern "C" {
    ...
    pub fn emane_controlmessages_find_receive_properties(
        msgs: *const ControlMessages,
    ) -> *const c_void;
    ...
    pub fn emane_frequencycontrol_get_segment(
        msg: *const c_void,
        offset: *mut u64,
        duration: *mut u64,
        frequencyHz: *mut u64,
    ...
    pub fn emane_ieee80211abg_maclayer_scheduleUpstreamCallback(
        maclayer: *mut c_void,
    ...
    pub fn emane_ieee80211abg_maclayer_parseMACHeader(
        pkt: *mut UpstreamPacket,
        out_params: *mut CMACHeaderParams,
    ) -> bool;
    pub fn emane_ieee80211abg_maclayer_updateCtrlChannelActivity(
        maclayer: *mut c_void,
        src: u16,
        dst: u16,
        msgType: u16,
    ...
    pub fn emane_ieee80211abg_maclayer_updateNeighborRxMetric(
        maclayer: *mut c_void,
        src: u16,
        seq: u64,
        uuid: *const c_void,
    ...
    pub fn emane_ieee80211abg_maclayer_updateDataChannelActivity(
        maclayer: *mut c_void,
        src: u16,
        msgType: u16,
        rxPower: f64,
    ...
    pub fn emane_ieee80211abg_maclayer_getRandomRxPowerCommonNodesMilliWatts(
        maclayer: *mut c_void,
        src: u16,
    ) -> f64;
    pub fn emane_ieee80211abg_maclayer_getAverageRxPowerPerMessageMilliWatts(
        maclayer: *mut c_void,
    ) -> f64;
    pub fn emane_ieee80211abg_maclayer_getRandomRxPowerHiddenNodesMilliWatts(
        maclayer: *mut c_void,
        src: u16,
    ) -> f64;
    pub fn emane_ieee80211abg_maclayer_getAverageRxPowerPerMessageHiddenNodesMilliWatts(
        maclayer: *mut c_void,
    ) -> f64;
    pub fn emane_ieee80211abg_maclayer_checkPOR(
        maclayer: *mut c_void,
        sinr: f64,
        pktLen: usize,
        dataRateKbps: u64,
    ) -> bool;
    pub fn emane_ieee80211abg_maclayer_checkForRxCollision(
        maclayer: *mut c_void,
        srcNEM: u16,
        u8Category: u8,
        tryNum: i32,
    ) -> u16;
    pub fn emane_ieee80211abg_maclayer_sendDownstreamUnicastCts(
        maclayer: *mut c_void,
        srcNEM: u16,
        durationMicroseconds: u64,
        timeNow: u64,
    );
    pub fn emane_ieee80211abg_maclayer_sendUpstreamPacket(
        maclayer: *mut c_void,
        pkt: *mut UpstreamPacket,
    );
    pub fn emane_ieee80211abg_maclayer_incrementUpstreamBroadcastDataDiscardDueToClobberRxDuringTx(
        maclayer: *mut c_void,
    );
    pub fn emane_ieee80211abg_maclayer_incrementUpstreamUnicastDataDiscardDueToClobberRxDuringTx(
        maclayer: *mut c_void,
    );
    pub fn emane_ieee80211abg_maclayer_incrementUpstreamBroadcastDataDiscardDueToClobberRxHiddenBusy(
        maclayer: *mut c_void,
    );
    pub fn emane_ieee80211abg_maclayer_incrementUpstreamUnicastDataDiscardDueToClobberRxHiddenBusy(
        maclayer: *mut c_void,
    );
    pub fn emane_ieee80211abg_maclayer_incrementUpstreamBroadcastNoiseRxCommon(
        maclayer: *mut c_void,
    );
    pub fn emane_ieee80211abg_maclayer_incrementUpstreamUnicastNoiseRxCommon(maclayer: *mut c_void);
    pub fn emane_ieee80211abg_maclayer_incrementUpstreamBroadcastNoiseHiddenRx(
        maclayer: *mut c_void,
    );
    ...
    pub fn emane_ieee80211abg_maclayer_incrementUpstreamUnicastRtsCtsDataRxFromPhy(
        maclayer: *mut c_void,
    );
...
pub extern "C" fn emane_ieee80211abg_mac_layer_processUpstreamPacket(
    ...
    unsafe {
        ...
        let priority = emane_packetinfo_get_priority(pkt_info);
        let category = emane_ieee80211abg_maclayer_dscpToCategory(maclayer, priority);
        let _src = emane_packetinfo_get_source(pkt_info);
        ...
        if p_recv_props.is_null()
            || p_freq_control.is_null()
            || emane_frequencycontrol_is_empty(p_freq_control)
        {
            // Drop packet
            return;
        }
        ...
        emane_frequencycontrol_get_segment(
            p_freq_control,
            &mut offset,
            &mut duration,
            &mut freq_hz,
        ...
        emane_ieee80211abg_maclayer_scheduleUpstreamCallback(
            maclayer, pkt, eor, timeNow, seq, category, rx_power, 0.0,
        );
    }
}
...
unsafe fn check_upstream_reception(
    ...
    let noise_mw = db_to_milliwatt(noise_floor_dbm);
    let mut noise_adj_mw = 0.0;

    let pkt_info = emane_upstreampacket_get_packetinfo(pkt);
    let src = emane_packetinfo_get_source(pkt_info);

    let collision_type = emane_ieee80211abg_maclayer_checkForRxCollision(
        maclayer,
        header.src_nem,
        category,
        try_num,
    ...
    if (collision_type & COLLISION_TYPE_CLOBBER_RX_DURING_TX) != 0 {
        if is_bcast {
            emane_ieee80211abg_maclayer_incrementUpstreamBroadcastDataDiscardDueToClobberRxDuringTx(
                maclayer,
            );
        } else {
            emane_ieee80211abg_maclayer_incrementUpstreamUnicastDataDiscardDueToClobberRxDuringTx(
                maclayer,
            );
        }
    ...
    if (collision_type & COLLISION_TYPE_CLOBBER_RX_HIDDEN_BUSY) != 0 {
        if is_bcast {
            ...
            emane_ieee80211abg_maclayer_incrementUpstreamUnicastDataDiscardDueToClobberRxHiddenBusy(
                maclayer,
            );
        }
    ...
    if (collision_type & COLLISION_TYPE_NOISE_COMMON_RX) != 0 {
        let rand_noise_mw =
            emane_ieee80211abg_maclayer_getRandomRxPowerCommonNodesMilliWatts(maclayer, src);
    ...
    if (collision_type & COLLISION_TYPE_NOISE_HIDDEN_RX) != 0 {
        let rand_noise_mw =
            emane_ieee80211abg_maclayer_getRandomRxPowerHiddenNodesMilliWatts(maclayer, src);
        noise_adj_mw += rand_noise_mw;
        if is_bcast {
    ...
    emane_ieee80211abg_maclayer_updateNeighborRxMetric(
        maclayer,
        src,
        seq,
        std::ptr::null(),
    ...
    unsafe {
        ...
        if !emane_ieee80211abg_maclayer_parseMACHeader(pkt, &mut header) {
            emane_ieee80211abg_maclayer_processOutbound(
                maclayer,
                u8Category,
                pkt as *mut DownstreamPacket,
                DROP_CODE_MAC_HEADER,
            );
            return;
        }

        let _is_promiscuous = emane_ieee80211abg_maclayer_getPromiscuosEnable(maclayer);
        let _my_id = emane_ieee80211abg_maclayer_get_registration_id(maclayer); // actually we need getId(), but we'll approximate
        ...
        let (success, _code) = check_upstream_reception(
            maclayer,
            pkt,
            timeNow,
            u64SequenceNumber,
            ...
            dNoiseFloordBm,
            &header,
            header.num_retries as i32,
            u8Category,
        );

        if success {
            if header.msg_type == MSG_TYPE_UNICAST_RTS_CTRL {
                emane_ieee80211abg_maclayer_sendDownstreamUnicastCts(
                    maclayer,
                    header.src_nem,
                    header.duration_microseconds,
                    timeNow,
                );
                ...
                emane_ieee80211abg_maclayer_updateCtrlChannelActivity(
                    maclayer,
                    header.src_nem,
                    header.dst_nem,
                    header.msg_type,
            ...
            } else if header.msg_type == MSG_TYPE_UNICAST_DATA
                || header.msg_type == MSG_TYPE_BROADCAST_DATA
            {
                if header.msg_type == MSG_TYPE_UNICAST_DATA {
                    emane_ieee80211abg_maclayer_incrementUpstreamUnicastRtsCtsDataRxFromPhy(
                        maclayer,
                    );
                }
                emane_ieee80211abg_maclayer_updateDataChannelActivity(
                    maclayer,
                    header.src_nem,
                    header.msg_type,
                    dRxPowerdBm,
