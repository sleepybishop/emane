...
use std::ffi::c_void;
use crate::ieee80211abg::mac_config::MACConfig;
...
impl ModeTimingParameters {
    pub fn new(mac_config: MACConfig) -> Self {
        ...
        timing_params[MODULATION_TYPE_DEFAULT] = TimingParams { rts_bit_length: 160, cts_bit_length: 112, ack_bit_length: 112, slot_microseconds: 9, sifs_microseconds: 10, preamble_microseconds: 192 };
        timing_params[MODULATION_TYPE_80211A] = TimingParams { rts_bit_length: 160, cts_bit_length: 112, ack_bit_length: 112, slot_microseconds: 9, sifs_microseconds: 16, preamble_microseconds: 20 };
        timing_params[MODULATION_TYPE_80211B] = TimingParams { rts_bit_length: 160, cts_bit_length: 112, ack_bit_length: 112, slot_microseconds: 20, sifs_microseconds: 10, preamble_microseconds: 192 };
        timing_params[MODULATION_TYPE_80211BG] = TimingParams { rts_bit_length: 160, cts_bit_length: 112, ack_bit_length: 112, slot_microseconds: 20, sifs_microseconds: 16, preamble_microseconds: 192 };
    ...
    pub fn get_slot_size_microseconds(&self) -> u64 {
        let mut slot = self.timing_params[self.mac_config.get_modulationtype() as usize].slot_microseconds;
    ...
    pub fn get_message_duration_microseconds(&self, category: u8, len: usize) -> u64 {
        let mode = self.mac_config.get_modulationtype();
        let rate_kbps = self.mac_config.get_unicastdataratekbps_by_category(category);
...
#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_new(config_ptr: *mut c_void) -> *mut c_void {
    Box::into_raw(Box::new(ModeTimingParameters::new(MACConfig::new(config_ptr)))) as *mut _
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_free(ptr: *mut c_void) {
    if !ptr.is_null() {
        unsafe { drop(Box::from_raw(ptr as *mut ModeTimingParameters)); }
    }
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_getSlotSizeMicroseconds(ptr: *mut c_void) -> u64 {
    unsafe { &*(ptr as *mut ModeTimingParameters) }.get_slot_size_microseconds()
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_getOverheadMicroseconds(ptr: *mut c_void, category: u8) -> u64 {
    unsafe { &*(ptr as *mut ModeTimingParameters) }.get_overhead_microseconds(category)
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_getDeferIntervalMicroseconds(ptr: *mut c_void, category: u8) -> u64 {
    unsafe { &*(ptr as *mut ModeTimingParameters) }.get_defer_interval_microseconds(category)
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_getMessageDurationMicroseconds(ptr: *mut c_void, category: u8, len: usize) -> u64 {
    unsafe { &*(ptr as *mut ModeTimingParameters) }.get_message_duration_microseconds(category, len)
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_getBroadcastMessageDurationMicroseconds(ptr: *mut c_void, len: usize) -> u64 {
    unsafe { &*(ptr as *mut ModeTimingParameters) }.get_broadcast_message_duration_microseconds(len)
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_getUnicastMessageDurationMicroseconds(ptr: *mut c_void, len: usize) -> u64 {
    unsafe { &*(ptr as *mut ModeTimingParameters) }.get_unicast_message_duration_microseconds(len)
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_getCtsMessageDurationMicroseconds(ptr: *mut c_void) -> u64 {
    unsafe { &*(ptr as *mut ModeTimingParameters) }.get_cts_message_duration_microseconds()
}

#[no_mangle]
pub extern "C" fn emane_ieee80211abg_modetimingparameters_getRtsMessageDurationMicroseconds(ptr: *mut c_void) -> u64 {
