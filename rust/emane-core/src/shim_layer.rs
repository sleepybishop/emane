...
extern "C" {
    ...
    fn emane_c_shim_layer_implementor_process_configuration(
        impl_ptr: *mut c_void,
        update: *mut c_void,
    );
    fn emane_c_shim_layer_implementor_process_upstream_packet(
        impl_ptr: *mut c_void,
        pkt: *mut c_void,
        msgs: *mut c_void,
    );
    fn emane_c_shim_layer_implementor_process_downstream_packet(
        impl_ptr: *mut c_void,
        pkt: *mut c_void,
        msgs: *mut c_void,
    );
    fn emane_c_shim_layer_implementor_process_upstream_control(
        impl_ptr: *mut c_void,
        msgs: *mut c_void,
    );
    fn emane_c_shim_layer_implementor_process_downstream_control(
        impl_ptr: *mut c_void,
        msgs: *mut c_void,
    );
    fn emane_c_shim_layer_implementor_set_upstream_transport(
        impl_ptr: *mut c_void,
        transport: *mut c_void,
    );
    fn emane_c_shim_layer_implementor_set_downstream_transport(
        impl_ptr: *mut c_void,
        transport: *mut c_void,
    );
    fn emane_c_shim_layer_implementor_process_event(
        impl_ptr: *mut c_void,
        event_id: *mut c_void,
        serialization: *mut c_void,
    );
    fn emane_c_shim_layer_implementor_process_timed_event(
        impl_ptr: *mut c_void,
        event_id: *mut c_void,
        expire: *const c_void,
...
#[no_mangle]
pub extern "C" fn emane_rs_shim_layer_create(
    cpp_this: *mut c_void,
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_do_process_configuration(
    ptr: *mut c_void,
    update: *mut c_void,
) {
    let shim = &mut *(ptr as *mut ShimLayer);
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_do_process_upstream_packet(
    ptr: *mut c_void,
    pkt: *mut c_void,
    msgs: *mut c_void,
) {
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_do_process_downstream_packet(
    ptr: *mut c_void,
    pkt: *mut c_void,
    msgs: *mut c_void,
) {
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_do_process_upstream_control(
    ptr: *mut c_void,
    msgs: *mut c_void,
) {
    let shim = &mut *(ptr as *mut ShimLayer);
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_do_process_downstream_control(
    ptr: *mut c_void,
    msgs: *mut c_void,
) {
    let shim = &mut *(ptr as *mut ShimLayer);
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_set_upstream_transport(
    ptr: *mut c_void,
    transport: *mut c_void,
) {
    let shim = &mut *(ptr as *mut ShimLayer);
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_set_downstream_transport(
    ptr: *mut c_void,
    transport: *mut c_void,
) {
    let shim = &mut *(ptr as *mut ShimLayer);
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_do_process_event(
    ptr: *mut c_void,
    event_id: *mut c_void,
    serialization: *mut c_void,
) {
...
#[no_mangle]
pub unsafe extern "C" fn emane_rs_shim_layer_do_process_timed_event(
    ptr: *mut c_void,
    event_id: *mut c_void,
    expire: *const c_void,
    schedule: *const c_void,
    ...
    let shim = &mut *(ptr as *mut ShimLayer);
    emane_c_shim_layer_implementor_process_timed_event(
        shim.implementor,
        event_id,
        expire,
        schedule,
