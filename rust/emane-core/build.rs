...
fn main() {
    ...
    println!(
        "cargo:rustc-link-search=native={}/src/libemane/.libs",
        emane_root_str
    );
    println!(
        "cargo:rustc-link-search=native={}/src/models/mac/ieee80211abg/.libs",
        emane_root_str
    );
    println!(
        "cargo:rustc-link-search=native={}/src/models/mac/tdma/.libs",
        emane_root_str
    );
    println!(
        "cargo:rustc-link-search=native={}/src/models/mac/rfpipe/.libs",
        emane_root_str
    );
    println!(
        "cargo:rustc-link-search=native={}/src/models/mac/bentpipe/.libs",
        emane_root_str
    );
    println!("cargo:rustc-link-lib=dylib=emane");

    cc::Build::new()
        .file("src/tdma_stubs.c")
        .file("src/ieee80211abg_stubs.c")
        .file("src/bentpipe_stubs.c")
        .compile("tdma_stubs");
}
